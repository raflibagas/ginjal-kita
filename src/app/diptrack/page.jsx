    ...
    <main className="min-h-screen bg-red-50">
      <div className="max-w-md mx-auto p-4 px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-4">
          <h2 className="text-lg font-bold text-gray-800">Masukkan Hasil Dipstick</h2>
          ...
          <div className="mb-4">
            {parameters.map(
              (param) =>
                param.id === activeTab && (
                  <div key={param.id}>
                    <p className="text-sm font-medium text-gray-800">{param.fullName}</p>
          ...
          {/* Color selection */}
          <div className="mb-2">
            <p className="text-sm mb-2 text-gray-800">Pilih hasil yang sesuai:</p>
          ...
          <div className="mb-4">
            <h3 className="text-sm font-medium text-gray-800">Hasil Terpilih</h3>
        ...
        <div className="mt-4 bg-white rounded-lg shadow-sm p-4">
          <h2 className="text-lg font-medium mb-4 text-gray-800">Hasil Sebelumnya</h2>

          <div className="border-l-4 border-yellow-400 pl-2 mb-3 flex justify-between">
            <div>
              <h3 className="text-sm font-medium text-gray-800">Moderately Increased Risk</h3>
